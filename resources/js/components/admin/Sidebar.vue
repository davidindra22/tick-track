<template>
    <aside class="w-64 bg-white shadow-lg">
        <div class="p-6 border-b border-gray-100">
            <h1 class="tect-2xl font-bold text-blue-600 flex items-center">
        ...
        <nav class="mt-6">
            <RouterLink
                ...
                class="flex items-center px-6 py-3 text-gray-600 hover:bg-gray-50 hover:border-l-4 hover:border-gray-400"
                :class="{
