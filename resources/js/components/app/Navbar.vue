                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button
                            ...
                            class="flex items-center bg-gray-50 px-4 py-4 rounded-full hover:bg-gray-100"
                        >
                            <img
                                :src="`https://ui-avatars.com/api/?name=${user?.name}&background=08D8ABC&color=fff`"
                                alt="Profile"
